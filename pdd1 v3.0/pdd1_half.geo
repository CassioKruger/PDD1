...
[
  ...
  N_ss = {19, Name "Aspectos Construtivos/Estator/var5", Label "Num de slots a mostrar",Highlight "SteelBlue"}
  ...
  N_rs = {3, Name "Aspectos Construtivos/Rotor/var9", Label "Num de slots a mostrar",Highlight "SkyBlue"},
